...
# ╔═╡ 9154c588-c9f5-11ec-37c0-631aa6078b94
begin
  using Flux
  using MLDatasets
end

# ╔═╡ 7c3594b9-01a1-4518-9509-c5e0e8959c39
md"""
In this notebook we show how to train basic neural networks in Flux.

### Regression
We shall try to train a neural network that approximates the function
```math
\begin{align}
  \mathbb{R} &\to \mathbb{R} \\
  x &\mapsto 4x + 2
...
A simple neural network with one layer, one neuron should suffice.
"""

# ╔═╡ f57314f2-2871-4593-ae84-9aa28d4dc991
actual(x) = 4x + 2

# ╔═╡ bad3f6a8-e8a7-4984-8461-e0416b6b420c
x_train, x_test = hcat(0:5...), hcat(6:10...)

# ╔═╡ c7c841fe-9909-4e58-a181-ba315482ee1c
y_trian, y_test = actual.(x_train), actual.(x_test)

# ╔═╡ be442615-3eef-4bc0-8675-afc5f1218869
model = Dense(1 => 1)

# ╔═╡ 60a8f0e2-ffa2-4bab-a579-7693b2ea6d17
model.weight, model.bias

# ╔═╡ 1a2162f5-b65b-4807-9a9e-7f31cfd62a6b
model(x_train)

# ╔═╡ c7487f5a-efee-494c-a1eb-c6c40e74d5e2
parameters = Flux.params(model)

# ╔═╡ 397c8490-697a-4775-a629-d5253796333a
model.weight in parameters, model.bias in parameters

# ╔═╡ dd1a17eb-4397-4c80-9d56-1dc5efccb3f1
md"""
The signature of the mean square error is
```julia
mse(ŷ, y; agg = mean)
```
"""

# ╔═╡ 0ff1483e-5226-4b85-aba1-abc8e600758e


# ╔═╡ a3bff5d3-f23a-4bdf-b38b-63aeb90f76bc
optimizer = Descent()
