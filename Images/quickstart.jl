...
# ╔═╡ c11e09c0-2a8e-11ec-3d6b-c59fc997247d
using Images

# ╔═╡ 6db43247-a191-4838-9b88-bfdc11029660
img = Array(reshape(range(0,stop=1,length=10^4), 100, 100))

# ╔═╡ 6fa1a173-85f5-4a15-a579-f158057c05aa
Gray.(img)

# ╔═╡ 5c833433-0c58-4f70-88b0-ce388e2a9dce
Gray.(img[:, end])

# ╔═╡ ec889533-7618-4f7f-83c5-d8c5fd0d93ee
Gray.(img[:, [end]])

# ╔═╡ 30c45791-2ae5-4141-adc9-c1d4ba52209d
Gray.(img[1, end]), Gray.(img[end, end])

# ╔═╡ a50b8c3b-322f-4b42-8c6c-16ca4587161b
img[1, end], img[end, end]

# ╔═╡ dc91c66c-cf25-43e7-8dcc-71e9c4618efc
begin
  # make a copy
  img_c = img[51:70, 21:70]
  # make a view
  img_v = @view img[16:35, 41:90]
  Gray.(img_c), Gray.(img_v)
end

# ╔═╡ 5825ba03-df71-43ec-bd63-b8dde0ecfeeb
begin
  fill!(img_c, 1)
  fill!(img_v, 0)
  Gray.(img_c), Gray.(img_v), Gray.(img)
end

# ╔═╡ 42168399-ddfb-4664-8d8e-7a40b27ca71c
md"""
## The 0-to-1 Intensity scale (`N0f8`, etc.)
"""

# ╔═╡ 2781e8f7-b4ac-46a8-b718-7dcbd9c9af7e
img_n0f8 = rand(N0f8, 2, 2)

# ╔═╡ 9ee475c4-f6e8-41f5-b058-31f6e9445e28
float.(img_n0f8)
