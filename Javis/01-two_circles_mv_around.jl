...
# ╔═╡ 3bec385a-066f-11ec-3e53-9d843e9c7074
begin
  using Javis
  using PlutoUI
end

# ╔═╡ 237befcc-62db-4865-8699-a9a0f90e1bed
function ground(args...)
    background("black")
    sethue("white")
end

# ╔═╡ e67c5b18-7137-4566-8088-feeffe14ebf6
function object(p=O, color="white", radius=25)
  sethue(color)
  circle(p, radius, :fill)
  return p
end

# ╔═╡ dcec7930-2854-4871-971d-bc591fe4c6b0
let
  myvideo = Video(500, 500)
  # Frames 1 to 70
  Background(1:70, ground)
  origin = Object(1:70, (args...) -> object(O, "white", 10), Point(0, 0))
  red_ball = Object(1:70, (args...) -> object(O, "red"), Point(100, 0))
  # Rotate around the origin O, for an angle of 2π
  act!(red_ball, Action(anim_rotate_around(2π, O)))

  # If you want to save the result to a file, just uncomment the line of pathname
  render(
    myvideo;
    #pathname="circle.gif"
  )
...
# ╔═╡ d0ff664f-e77c-499b-9ddf-2c179672d8bf
let
  myvideo = Video(500, 500)
  Background(1:70, ground)
  origin = Object(1:70, (args...) -> object(O, "white", 10), Point(0, 0))
  ...
  # 2π, 0.0 means going from 2π to 0.0, i.e. counter-clockwise, around red_ball
...
# ╔═╡ 62856c3d-5f5a-429f-b910-1c9ff80f13a6
md"""
Note that

- normally, an angle from `2π` to `0` should mean _clockwise_, but since in computer vision we have our ``y``-axis pointing downward instead of upward, it is _counter-clockwise_

"""

# ╔═╡ a122bd52-19e7-415f-abcb-06acd7ea0178
function trajectory!(points, pos, color)
  sethue(color)
  push!(points, pos)
  circle.(points, 2, :fill)
end

# ╔═╡ 9155c24e-d857-4e5a-a692-6517007f7ebc
typeof(Point[]), typeof(Point)

# ╔═╡ 5d180f04-c84a-4312-a2e7-45f75eddf7d3
md"""
Let's leave the next cell incomplete by omitting the `render()` method.
"""

# ╔═╡ 384557f6-48e3-4be1-9aa4-1016e185c8bf
let
  myvideo = Video(200, 500)
  trajectory_red = Point[]
  Background(1:70, ground)
  red_ball = Object(1:70, (args...)->object(O, "red"), Point(100, 0))
  act!(red_ball, Action(anim_rotate_around(2π, O)))
  Object(1:70, (args...)->trajectory!(trajectory_red, pos(red_ball, "red")))
end

# ╔═╡ 34a86bb5-25a1-4bdc-ab08-12f621b3a597
md"""
Ok, now, let's add the `render()` back.
"""

# ╔═╡ 0f1e80ec-00fd-42c0-8201-1c0a8df2871f
let
  myvideo = Video(200, 500)
  trajectory_red = Point[]
  Background(1:70, ground)
  Object(1:70, (args...) -> object(O, "white", 10), Point(0, 0))
  red_ball = Object(1:70, (args...)->object(O, "red"), Point(100, 0))
  act!(red_ball, Action(anim_rotate_around(2π, O)))
  Object(1:70, (args...)->trajectory!(trajectory_red, pos(red_ball), "red"))
  render(myvideo)
...
# ╔═╡ a735ce31-ef47-45bb-bddf-c2b17d5ab540
@which pos

# ╔═╡ 35f041f8-4424-47c9-8ef9-19052914612b
@doc pos

# ╔═╡ 39f2f8ac-a330-4bbe-8875-997b20238aaa
@doc get_position

# ╔═╡ 8ad2a548-2203-4d0d-8da7-5d2b73f82c24
function connector(p1, p2, color)
  sethue(color)
  line(p1, p2, :stroke)
end

# ╔═╡ 00a3cab6-fcc3-4706-86d8-59598b18d6a5
let
  myvideo = Video(500, 500)
  Background(1:70, ground)
  Object(1:70, (args...) -> object(O, "white", 10), Point(0, 0))
  ...
  blue_ball = Object(1:70, (args...) -> object(O, "blue"), Point(200, 80))
  act!(blue_ball, Action(anim_rotate_around(2π, 0.0, red_ball)))
  Object(1:70, (args...)->connector(pos(red_ball), pos(blue_ball), "turquoise"))
  render(myvideo;)
end

# ╔═╡ a0039a5f-aa81-4271-b378-4f46b40a84ae
let
  myvideo = Video(500, 500)
  trajectory_red = Point[]
  trajectory_blue = Point[]
  Background(1:70, ground)
  Object(1:70, (args...) -> object(O, "white", 10), Point(0, 0))
  red_ball = Object(1:70, (args...) -> object(O, "red"), Point(100, 0))
  act!(red_ball, Action(anim_rotate_around(2π, O)))
  ...
  Object(1:70, (args...)->connector(pos(red_ball), pos(blue_ball), "turquoise"))
  Object(1:70, (args...)->trajectory!(trajectory_red, pos(red_ball), "red"))
  Object(1:70, (args...)->trajectory!(trajectory_blue, pos(blue_ball), "blue"))
  render(myvideo;)
end
...
git-tree-sha1 = "bd8b23bd0f7382aaddb5332d92e692a8ee1e8db3"
...
git-tree-sha1 = "8b5552a7a9efc2b0565e2256c919651e6f4e7931"
...
[[VideoIO]]
deps = ["ColorTypes", "Dates", "FFMPEG", "Glob", "ImageCore", "ImageTransformations", "Libdl", "ProgressMeter", "Requires"]
git-tree-sha1 = "5beecd069b48a6d23a64328401489e6556d6cda3"
